...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    // Removed automatic redirect to /auth for unauthenticated users — allow anonymous access.
    // If there is no authenticated user, skip subscription/billing enforcement and allow the request to continue.
    if (!user) {
